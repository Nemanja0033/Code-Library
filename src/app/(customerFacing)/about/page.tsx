  ...
  return (
    <div className="container mx-auto p-8">
      <div className="animate-pulse">
        <h1 className="bg-gray-200 h-10 w-2/3 mx-auto rounded mb-6"></h1>
        <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
          <p className="bg-gray-200 h-6 w-5/6 mx-auto rounded mb-4"></p>
          <p className="bg-gray-200 h-6 w-5/6 mx-auto rounded mb-4"></p>
        </div>
        <h2 className="bg-gray-200 h-8 w-1/2 mx-auto rounded mb-6"></h2>
        <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
          <p className="bg-gray-200 h-6 w-5/6 mx-auto rounded mb-4"></p>
          <p className="bg-gray-200 h-6 w-5/6 mx-auto rounded mb-4"></p>
        </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
          ...
          <ul className="list-disc list-inside text-lg">
            {Array.from({ length: 5 }).map((_, index) => (
              <li key={index} className="bg-gray-200 h-4 w-5/6 mx-auto rounded mb-2"></li>
            ))}
          </ul>
        </div>
      </div>
